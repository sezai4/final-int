...
<body>
        ...
        <div class="container-fluid text-bg-info p-3">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="girisyap.php">GİRİŞ YAP</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="kaydet.php">KAYIT OL</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="cikis.php">ÇIKIŞ YAP</a> <!-- Bu satır eklenmiştir -->
                    </li>
                </ul>
    ...
    <div class="container">
        ...
        <div class="card" >
            ...
            <div class="card-body">
                ...
                <p class="card-text" style="background-color: yellow;"> ' . $row["yayinevi"] . ' </p>
    ...
    <footer class="py-3 my-4">
        <ul class="nav justify-content-center border-bottom pb-3 mb-3 footer-nav">
            ...
            <li class="nav-item"><a href="iletisim.php" class="nav-link px-2 text-body-secondary">iletişim</a></li>
            ...
            <ul class="social-icons">
                <style>
                    ...
                    .social-icons li {
                        ...
                        margin-right: 10px;
                        /* Aralıkları ayarlayabilirsiniz */
                    }

                    .social-icons li:last-child {
                        margin-right: 0;
                        /* Son öğenin aralığını sıfırlar */
                    }
                </style>
